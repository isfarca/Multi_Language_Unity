...
public class MultiLanguage : ScriptableObject
{
    ...
    [SerializeField]
    private Document polyglotDocument = null;

    public Document PolyglotDocument { get { return polyglotDocument; } }
    

    [SerializeField]
    private Document customDocument = null;

    public Document CustomDocument { get { return customDocument; } }
    ...
    private static bool HasInstance
    {
        get
        {
            if (instance == null)
            {
                instance = Resources.Load<MultiLanguage>("Localization");
            }
...
#region Arabic Support
    ...
    public bool InputFilesContains(Document doc)
    {
